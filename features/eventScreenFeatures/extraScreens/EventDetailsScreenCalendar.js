...
const EventDetailsScreenCalendar = ({navigation, route}) => {
            ...
            <SafeAreaView>
                ...
                <ScrollView>
                    ...
                    <View style={[styles.imageBox, {backgroundColor: 'transparent'}]}>
                        ...
                        <EventDetailButton onPress={() => navigation.navigate("weeklyCalendarScreen")}/>
                    </View>
...
export default EventDetailsScreenCalendar;