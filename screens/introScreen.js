...
const IntroScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.splashContainer}>
        <Image 
          source={require('/Users/thebenzsecrets/lumina4.0/assets/newAssets/universalAssets/splash.png')}
          style={styles.splashImage} 
        />
        <TouchableOpacity onPress={handleStartPress} style={styles.tapToStartContainer}>
  ...
  //           style={styles.splashImage} 
  //         />
  //         <TouchableOpacity onPress={handleSplashPress} style={styles.tapToStartContainer}>
  //           <Text style={styles.tapToStartText}>Tap to Start</Text>
  //         </TouchableOpacity>
  //       </View>
  //     ) : (
  ...
  //                   index === 0 ? styles.darkBlue : 
  //                   (index === 1 ? styles.lightBlue : styles.customStyleForThirdSlide)
  //                 ]}>
